...
function mapClerkUsers(clerkUsers: { data: Array<{ id: string; fullName: string | null; firstName: string | null; lastName: string | null; emailAddresses: Array<{ emailAddress: string }> }> }) {
  const map = new Map()
...
function mergePhotographers(dbPhotographers: Array<{ clerkId: string; [key: string]: unknown }>, clerkMap: Map<string, { name: string; email: string | null }>) {
