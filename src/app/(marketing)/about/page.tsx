...
export default function AboutPage() {
  return (
    <div className="flex flex-col gap-20 pb-20 text-foreground">
      <section className="relative pt-20 pb-16 bg-muted/10 overflow-hidden">
        <div className="container mx-auto px-4 md:px-8 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-black text-foreground mb-6">
            Tentang <span className="text-primary">Framic</span>
          </h1>
      ...
      <section className="container mx-auto px-4 md:px-8 grid md:grid-cols-3 gap-12">
        <div className="flex flex-col gap-4 text-center items-center">
          ...
          <p className="text-muted-foreground">Mempermudah akses layanan fotografi profesional bagi siapa saja, di mana saja.</p>
        </div>
        <div className="flex flex-col gap-4 text-center items-center">
          ...
          <p className="text-muted-foreground">Mengutamakan kualitas, transparansi, dan keamanan dalam setiap transaksi.</p>
        </div>
        <div className="flex flex-col gap-4 text-center items-center">
          ...
          <p className="text-muted-foreground">Membangun ekosistem yang sehat bagi para fotografer untuk terus bertumbuh.</p>
        </div>
      </section>
    </div>
  )
