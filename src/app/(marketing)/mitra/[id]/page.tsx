      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
        <div className="lg:col-span-2 space-y-8">
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="w-32 h-32 md:w-40 md:h-40 bg-slate-100 rounded-[2.5rem] overflow-hidden shrink-0 border-4 border-white shadow-xl flex items-center justify-center text-slate-300">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex flex-wrap items-center gap-6 text-slate-500 font-bold text-sm">
                <span className="flex items-center gap-2">
                  <MapPinIcon className="w-4 h-4 text-rose-500" /> {mitra.alamat || "Lokasi tidak disebutkan"}
                </span>
                {mitra.websiteUrl && (
                  <a
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-100/50">
            <h2 className="text-xl font-black text-slate-900 mb-4">Tentang Mitra</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {mitraEvents.length > 0 ? (
            ...
            <div className="col-span-full py-24 text-center bg-slate-50 border-2 border-dashed border-slate-200 rounded-[3rem]">
              ...
              <p className="text-slate-400 font-medium">Mitra belum mempublikasikan agenda event.</p>
            </div>
          )}
        </div>
      </section>
