      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
        <div className="lg:col-span-2 space-y-8">
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="w-32 h-32 md:w-40 md:h-40 bg-card rounded-[2.5rem] overflow-hidden shrink-0 border-4 border-card shadow-xl flex items-center justify-center text-muted-foreground/30">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 pt-8 border-t border-white/10 flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-accent bg-accent-foreground/15 flex items-center justify-center text-[10px] font-black">
                      PG
                    </div>
                  ))}
                </div>
                <p className="text-[10px] font-black uppercase text-white/70">Tim Fotografer Aktif</p>
              </div>
            </div>
          </Card>
        </div>
