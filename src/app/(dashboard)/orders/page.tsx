  ...
  return (
    <div className="container mx-auto p-4 md:p-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
        <div>
          <h1 className="text-3xl font-black tracking-tighter text-slate-900 mb-1">Semua Order</h1>
      ...
      <div className="grid gap-4">
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-rose-50 rounded-3xl border border-rose-100 font-bold text-rose-500">
          ...
          <div className="text-center py-24 bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200">
            ...
            <p className="text-slate-500 mb-8 font-medium">Sepertinya Anda belum melakukan booking apa pun.</p>
