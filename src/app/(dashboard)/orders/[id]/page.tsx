              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-center gap-5 p-6 rounded-[2rem] border-2 border-dashed border-slate-100 bg-slate-50/50">
                    <div className="w-14 h-14 bg-white shadow-md rounded-full flex items-center justify-center text-slate-300 font-black text-xl uppercase overflow-hidden">
                      {isCustomer ? (order.photographer?.username || "P").slice(0, 1) : (order.customerName || "C").slice(0, 1)}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="font-black text-slate-900 text-lg uppercase tracking-tight truncate">
                        {isCustomer ? order.photographer?.username : order.customerName}
                      </div>
